...
const PURPOSE_DESCRIPTIONS: Record<DefaultAccountPurpose, string> = {
  ...
  PAYROLL_TAX_PAYABLE: "Liability account for payroll taxes withheld and payable to the tax authority.",
  BPJS_PAYABLE: "Liability account for BPJS contributions payable.",
